...
bool debug_startup = true; // set this false to stop the debug light sequence that
                           ...
                           // burnt out
bool simple_light_pattern = false; // TODO - control this with an external switch

const int num_of_lights = 6;
uint8_t light_sequence[num_of_lights] = { 2, 3, A0, A1, A2, A3 };
